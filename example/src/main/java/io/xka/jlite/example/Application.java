...
//            ArrayBlockingQueue<HttpControl.SSEEvent> queue = ctl.sse(10, Duration.ofSeconds(10));
//            ArrayBlockingQueue<HttpControl.SSEEvent> listenerQueue = new ArrayBlockingQueue<>(10);
...
//            while (true) {
//                try {
//                    HttpControl.SSEEvent sseEvent = listenerQueue.take();
...
//
//        private final ArrayBlockingQueue<HttpControl.SSEEvent> queue;
//
//        public Listener(ArrayBlockingQueue<HttpControl.SSEEvent> queue) {
//            this.queue = queue;
//        }
//
//        @Override
...
//            HttpControl.SSEEvent sseEvent = new HttpControl.SSEEvent("message", context);
//            try {
//                queue.put(sseEvent);
//            } catch (InterruptedException e) {
//                throw new RuntimeException(e);
...
//            try {
//                queue.put(new HttpControl.SSEEvent("close", "close"));
//            } catch (InterruptedException e) {
//                throw new RuntimeException(e);
//            }
